...
const Footer = () => {
  ...
  return (
    <footer className="py-12 px-4 flex flex-col text-center md:text-start md:flex-row md:justify-between bg-neutral">
      ...
      <div className="flex justify-center md:justify-end items-end gap-8">
